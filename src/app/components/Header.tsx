        ...
        <header className="w-full relative rounded-[20px] bg-[#1b1b1b] border border-[#1b98e0] h-[88px]">
          <div className="flex justify-between items-center h-full px-6">
            ...
            <div className="flex-shrink-0">
              <Link href="/" className="flex items-center">
                <Image
                  ...
                  alt="Logo"
                  width={200}  // Adjusted for better fit
            ...
            <nav className="hidden md:flex space-x-8">
              <Link href="/about" className="text-white hover:text-[#1B98E0] transition-colors">
                About
              </Link>
              <Link href="/services" className="text-white hover:text-[#1B98E0] transition-colors">
                Services
              </Link>
              <Link href="/portfolio" className="text-white hover:text-[#1B98E0] transition-colors">
                Portfolio
              </Link>
              <Link href="/contact" className="text-white hover:text-[#1B98E0] transition-colors">
                Contact
              </Link>
            </nav>
