  ...
  return (
    <section className="w-full py-16 px-4 bg-[#101111]">
      <div className="max-w-[1046px] mx-auto relative">
        <div className="mb-12">
          <h2 className="text-white text-4xl font-normal font-['Poppins'] mb-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start">
          <div className="max-w-[468px] mb-8 md:mb-0">
            <p className="text-white text-base font-normal font-['SF Pro'] mb-9">
            ...
            <button className="px-7 py-2.5 bg-[#1b1b1b] rounded-[72.09px] border border-[#1b98e0] text-white text-base font-['SF Pro'] hover:bg-[#1b98e0] transition-colors duration-300">
              Send us a message
            </button>
          </div>
